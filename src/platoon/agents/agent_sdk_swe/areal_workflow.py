...
from platoon.agents.agent_sdk_swe.rollout import run_single_rollout_process
...
class AgentSDKSWEArealWorkflow:
    ...
    async def arun_episode(self, engine, data: dict) -> dict:
        ...
        instance_id: str = data['instance_id'] # NOTE: SWE-Bench/SWE-Gym/SWE-Smith have an instance_id field that uniquely identifies each issue.
        # TODO: how to configure LLM generation hyperparams?
        # llm_config_file = data["llm_config"] # path to the JSON file containing the LLM config (in benchmarks and agent-sdk format)
        
        args = (instance_id, config)
        ...
        # TODO: check if the return structure of run_single_rollout_process matches below format
