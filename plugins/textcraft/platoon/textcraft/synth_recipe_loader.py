...
from .synth_recipe_generator import SynthRecipeDatabase, SynthRecipe
...
class SynthRecipeLoader:
    ...
    def __init__(self, recipes_dir: Optional[Path] = None, seed: int = 42, items_per_domain_tier: int = 8):
        """
...
def create_synth_recipe_database(seed: int = 42, items_per_domain_tier: int = 8) -> SynthRecipeLoader:
