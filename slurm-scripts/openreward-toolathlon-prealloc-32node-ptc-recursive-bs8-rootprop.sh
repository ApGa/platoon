#!/bin/bash
#SBATCH --job-name=openreward-ta32-rec-rootprop
...
#SBATCH --output=/lustre/fsw/portfolios/nvr/projects/nvr_lacr_llm/users/apurvag/logs/openreward-ta32-rec-rootprop-%j.out
#SBATCH --error=/lustre/fsw/portfolios/nvr/projects/nvr_lacr_llm/users/apurvag/logs/openreward-ta32-rec-rootprop-%j.err
...
# Force a fresh root-propagation lineage across all automatic successors.
export OPENREWARD_TRIAL_NAME=ta32-rec-rootprop-v1-trial0
export OPENREWARD_SUBAGENT_DELEGATION_REWARD_COEFFICIENT=0.0
export OPENREWARD_WANDB_MODE=online
export OPENREWARD_JOB_SCRIPT=${REPO_ROOT}/slurm-scripts/openreward-toolathlon-prealloc-32node-ptc-recursive-bs8-rootprop.sh
